...
#include <vector>
using namespace std;
//check if there is three numbers that their sum adds up to 15
...
//check if the number that the user chooses is in the vector
...
//function to erase the number that every user choose in order not to choose any number more than one time
